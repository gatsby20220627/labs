...
int main(int argc, char** argv) {
  ...
  int num_null = num_occurrences(str2, ' ');
  assert(num_null == 0);

  printf(
      "Congrats! If you have made it to this line, your Part 1 Test cases are "
      "all passing!\n");
  ...
  printf(
      "Congrats! If you have made it to this line, your Part 2 Test cases are "
      "all passing!\n");
